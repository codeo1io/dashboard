...
run: 'f4622d7ef78c49a7ae97725fe4d1b683 (stranded-run record — its landing commit ecedc26 was integrated late on 2026-09-24, conflict case 06d38b7d; numbered -3 per the #4315 filename-collision convention: the primary path holds run 270220e7’s re-scope record, whose batch landed as 916783f)'
phase: prioritize
