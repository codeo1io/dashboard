...
> rm-155..rm-162 added this session (ids renumbered at integrate-merge into 82312f7: rm-155→rm-164, rm-156→rm-165, rm-157→rm-166, rm-158→rm-167, rm-159→rm-168 — clearing the parallel cycle-9 landing's rm-154/rm-157/rm-159 and the stranded conductor/run-91e4626dccaf 943d3ed lineage's rm-155/156/157/158; rm-160..rm-162 keep their ids — see the ROADMAP header integrate note); base ROADMAP carries rm-100..rm-133, origin/main carries
...
- rm-164 fleet self-inclusion (79.0, highest new value): requires out-of-worktree operator
...
- rm-165 trends + rm-166 history persistence: sequencing (persistence first, both medium-large);
  next cycle's core.
- rm-167 posture audit / rm-160 attestations: depend on rm-107/rm-119 status surface and rm-105
...
- Deferred with cause: rm-164 (self-inclusion — needs repos.yaml data-branch + App install, outside
