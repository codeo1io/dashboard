...
mode: repo-grounded
run: 'f4622d7e, research phase (stranded branch, restored at landing 2026-09-24) — numbered -3 per the parallel-campaign collision protocol (docs/solutions/workflow-issues/parallel-conductor-campaigns-frame-movement-collisions-2026-09-20.md): the unnumbered path carries the landed 779e7271 doc, -2 carries f69cd740. Id mapping at landing (ROADMAP.md manual-revision header): this lineage rm-112→rm-116, rm-113→rm-117, rm-114→rm-118, rm-115→rm-119, rm-116→rm-120, rm-117→rm-121, rm-118 folded into rm-112; rm-100/110/111 kept their ids'
---
