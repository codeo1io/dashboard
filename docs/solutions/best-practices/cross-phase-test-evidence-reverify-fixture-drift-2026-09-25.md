...
the durable follow-up is ROADMAP item rm-190 (field-complete fixture
factories; minted as rm-187 by the run, renumbered rm-187→rm-190 at the
integrate merge into 4d8ec12 because the landed f1ae52a3 batch owns rm-187).
...
- ROADMAP `rm-190` — prevention candidate minted cycle-13 compound (renumbered
  from rm-187 at the integrate merge; the landed links-parse item owns rm-187)
