...
> **Provenance (integrate 2026-09-26, conflict case 20ad3ce1):** this solution doc
> rode candidate 009f029 (run 7cf68fea, PRs #149/#151 ephemeral validation) into
> main 65830f1; its lineage id rm-197 renumbers to **rm-242** at that landing
> (main's landed rm-197 is the cold-start banner + transport-timeout item, run
> ec07634c) — `rm-242` references below were authored as `rm-197`.
...
- The surviving true half of the finding (artifact paths `test-results/`,
  ...
  rm-242 completion rider (renumbered at landing from its mint id rm-197) and implemented; the ROADMAP rm-186 status line
