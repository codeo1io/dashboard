...
- Cycle-10 batch doc (this lineage's copy, renamed at the 2026-09-25
  integrate — the canonical cycle-10 path belongs to the parallel landed
  lineage):
  `docs/prioritization/2026-09-24-cycle-10-batch-run-a4a97e30.md` (B1,
  rm-164 in that lineage's numbering; the enumeration shape it describes —
  `skippedInstallations` — was superseded at the integrate by main's landed
  `enumerationIncomplete` channel, rm-112; the isolation lesson stands).
