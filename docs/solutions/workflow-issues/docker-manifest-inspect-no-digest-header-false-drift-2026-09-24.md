...
tags:
  ...
  - guard-test
related:
  - docs/solutions/workflow-issues/ci-digest-readback-empty-extraction-is-error-2026-09-24.md
---
...
- Sibling writeup of the same root cause from the parallel cycle-12 run (rm-178):
  docs/solutions/workflow-issues/ci-digest-readback-empty-extraction-is-error-2026-09-24.md
  — digest-class (index vs per-platform) and registry-HEAD probe angles; both runs'
  repairs converged on the same workflow edit (attribution note in base-drift.yaml).
