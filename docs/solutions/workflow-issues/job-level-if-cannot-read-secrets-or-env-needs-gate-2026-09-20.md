...
Shipped 2026-09-20 via rm-100a (run f4622d7e, whose own landing
stranded mid-commit). The retry run's batch landed on main at 916783f as
escape (a): `fro-bot.yaml` carries job-level `env: HAS_FRO_BOT_PAT: ${{ secrets.FRO_BOT_PAT != '' }}`
