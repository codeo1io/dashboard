...
- When GitHub Dependabot auto-dismisses the same advisory (`auto_dismissed`,
  ...
  divergence is explained rather than mysterious (see the overrides comment
  in pnpm-workspace.yaml — id note: this doc's original "ROADMAP rm-171"
  reference predates the 2026-09-25 integrate that reallocated rm-171 to the
  landed graceful-shutdown item; the override itself landed via cycle-13's
  content rescue of this batch).
