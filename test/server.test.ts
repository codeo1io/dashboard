...
// ---------------------------------------------------------------------------
// /privacy — public policy route (upstream #496 port)
//
...
// ---------------------------------------------------------------------------
// rm-198: monitoring refresh gate (DASHBOARD_MONITORING_REFRESH)
// ---------------------------------------------------------------------------

describe('readMonitoringRefreshConfig — refresh loop gate (rm-198)', () => {
