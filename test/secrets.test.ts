/**
 * Direct test coverage for src/secrets.ts hardening branches (rm-228 — landed at the
 * 2026-09-26 integrate; the batch that authored this file minted it as rm-143, an id main
 * had already given to the security-posture doc item).
 *
 ...
 * src/secrets.ts itself must remain diff-free (roadmap rm-228 acceptance).
 *
