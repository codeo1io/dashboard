...
describe('installShutdownHandlers', () => {
  ...
  // -------------------------------------------------------------------------
  // rm-197 — socket drain: idle keep-alives must not ride the deadline
  // -------------------------------------------------------------------------

  it('rm-197: destroys idle connections once the drain begins (quiet stop no longer rides the deadline)', () => {
    const h = makeHarness()
  ...
  it('rm-197: destroys ALL remaining sockets at the force-exit deadline, before exit(1)', () => {
    const h = makeHarness()
  ...
  it('rm-197: socket-close APIs throwing never blocks the drain or the forced exit', () => {
