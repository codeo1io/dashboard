...
// ---------------------------------------------------------------------------
// rm-161 — databaseId coverage accounting for the partial-protection warning
// (carried from the cycle-8 batch's rm-154 finding — main landed the parser
// accounting independently as rm-161; these tests pin that landed behavior)
// ---------------------------------------------------------------------------

describe('rm-161 — redactedEntriesMissingDatabaseId accounting', () => {
