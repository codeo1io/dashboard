/**
 * Boot-time snapshot persistence (rm-200).
 *
 ...
 *   (empty boot, exactly the pre-rm-200 contract).
 ...
 * the default, which keeps the pre-rm-200 in-memory-only behavior. Wire the
